...
|| Expression: | Meaning: |
|-|-----------|---------|
| 1.1 | **Registration** |    means the process prescribed by the DAC, pursuant to and/or in accordance with the Constitution, whereby VIG Tokens are activated or enabled through the use of prescribed software, as a method by which, and for the purposes of, accepting a VIG Token and constituting the holder thereof as a Member of the DAC and subject to the Constitution and the Terms and Conditions, to the extent of such VIG Tokens held from time to time |
...
| 1.5 | **Custodian Board** | or "Board"means the representative and governance board of the DAC that, save and except for the Genesis Board, shall consist of a maximum of twenty one (21) persons appointed by the Members in accordance with the provisions of the Constitution, which Custodian Board shall be first constituted upon the transfer of the VIG Tokens onto an EOSIO blockchain and the initialization of a voting Dapp, and which Board shall have such powers and duties as are set out in the Constitution |
...
| 1.7 | **DAC** | the DAC decentralized autonomous community of Members governed by and administered in accordance with the terms and conditions of the Constitution, which community of Members shall be collectively referred to as the "DAC" |
| 1.8 | **VIG Token** | means a VIG Token, the acceptance of which shall constitute the holder thereof as a Member of the DAC, represent the membership of such holder of the DAC and facilitate the automated governance of the DAC, all subject to and in accordance with the provisions of the Constitution |
...
| 1.11 | **Genesis Member** | means members of the DAC, entitled, _qua_ Member, to all the benefits and subject to all the obligations set out in the Constitution |
| 1.12 | **Genesis Board** | means members of the DAC, entitled, _qua_ Member, to all the benefits and subject to all the obligations set out in the Constitution |
...
| 1.22 | **Terms &amp; Conditions** | means the terms and conditions relating to the DAC and VIG Tokens, attached to the Schedule to this Constitution and incorporated into this Constitution and from time to time |
...
| 1.24 | **Token Distribution** | means the initial distribution of the VIG Tokens by the Genesis Member to specified persons, or their assignees or transferees, inviting such persons to accept and hold VIG Tokens, _gratis_, and to become members of the DAC |
| 1.25 | **Voting Directive** | means rules and regulations, approved by Special Resolution, as amended, restated, supplemented or otherwise modified from time to time, prescribing the subject matter of (where applicable), and the procedure, qualifications and mechanism for, voting by Members and Custodians, including but not limited to quorums, consensus and staking of VIG Tokens |
| 1.26 | **Website** | means the website published and maintained by or on behalf of the DAC and hosted at [https://eosUSD.com/](https://eosUSD.com/) or such other URL prescribed by Resolution. |
...
&nbsp;&nbsp;&nbsp; **1.29** A reference in this Constitution to voting in relation to Members shall be construed as a reference to voting by Members to the extent of the number of VIG Tokens held by such Members, with the votes being allocated to the number of such VIG Tokens being counted as voted and not the number of Members who actually voted
...
&nbsp;&nbsp;&nbsp; **3.1** __Nature:__ VIG Tokens shall, upon registration, constitute and represent the holder thereof as a Member of the DAC, to the extent of VIG Tokens held from time to time, and shall enable the automated governance of the DAC, all subject to and in accordance with the provisions of the Constitution.

&nbsp;&nbsp;&nbsp; **3.2** __Number:__ An initial number of 1, 000, 000, 000 (One Billion) VIG Tokens shall be made available for distribution by the Genesis Member at the Token Distribution, and thereafter the number of tokens shall be determined, or be determinable, in the manner prescribed by the Custodian Board, from time to time, by Extraordinary Resolution.

&nbsp;&nbsp;&nbsp; **3.3** __Membership:__ VIG Tokens shall, upon registration, constitute and represent the holder thereof, from time to time, as a Member of the DAC, entitled qua Member to all the benefits, and subject to all the obligations, set out in this Constitution and in proportion to the number of VIG Tokens held by such holder, from time to time, PROVIDED ALWAYS that Membership shall be inseparably linked to possession and control of the VIG Tokens and should any holder thereof lose possession or control of or over any such VIG Tokens, such holder shall be deemed immediately terminated as a Member and shall not be entitled qua Member to any benefits, or subject to any obligations, as aforesaid, to the extent of the VIG Tokens over which possession or control was lost.

&nbsp;&nbsp;&nbsp; **3.4** __Benefits of Members:__ The VIG Tokens shall entitle the holder thereof and from time to time, _qua_ Member of the DAC, to the following rights in proportion to the number of VIG Tokens held by such holder as measured against the total number of outstanding VIG Tokens:
...
&nbsp;&nbsp;&nbsp; **3.5** __Obligations of Members:__ The VIG Tokens shall subject the holder thereof and from time to time, _qua_ Member of the DAC, to the following obligations in proportion to the number of VIG Tokens held by such holder as measured against the total number of outstanding VIG Tokens:
...
1. (b) Obligation of Governance by the DAC, binding each Member, and each Member's property rights held in common with each other Member, to governance by, and administration in accordance with, the provisions of the Constitution with respect to any matter relating to the VIG Tokens, the DAC and/or the Constitution.
...
&nbsp;&nbsp;&nbsp; **3.6** __No Redemption:__  VIG Tokens shall not be redeemable at the instance of the holder of a VIG Token or the DAC.

&nbsp;&nbsp;&nbsp; **3.7** __Voluntary Cancellation of VIG Tokens:__ VIG Tokens may be &quot;burnt&quot; at the instance of any holder thereof, subject to and in accordance with this Constitution. Members wishing to &quot;burn&quot; VIG Tokens (or any part thereof) shall be permitted to do so in accordance with the &quot;burn transaction&quot; prescribed by the DAC. Upon &quot;burning&quot; of a VIG Token, the membership of the DAC linked to such VIG Token shall expire immediately and the holder thereof shall have no further entitlements _qua_ member to any benefit, and shall be subject to no further obligations, linked to the &quot;burnt&quot; VIG Token, which rights and obligations shall stand assigned and/or distributed amongst the remaining VIG Tokens.

&nbsp;&nbsp;&nbsp; **3.8** __Transfer of VIG Tokens:__

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; **3.8.1** VIG Tokens shall be transferable by any holder thereof by delivery of possession and control thereof.

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; **3.8.2** Any transfer of VIG Tokens shall be completed by registration of such VIG Tokens by the transferee thereof and in accordance with the Constitution.

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; **3.8.3** Upon transfer of any VIG Token, the transferor thereof shall cease to be a Member of the DAC, to the extent of the VIG Tokens transferred, and the transferee thereof shall be constituted as a Member of the DAC and entitled _qua_ Member to all the benefits, and be subject to all the obligations, set out in this Constitution and in proportion to the number of VIG Tokens transferred to such transferee and, for the purposes of the Constitution, all unrealized and/or undistributed benefits and obligations accruing with respect to the transferred VIG Tokens shall be deemed assigned to the transferee as of the date of transfer.
...
&nbsp;&nbsp;&nbsp; **3.11** __Joint Holders:__ If several persons exercise joint possession and control of any VIG Tokens, then such persons shall be constituted as joint Members of the DAC and any one of such persons may exercise and/or give receipt for any benefit linked to such VIG Tokens held by such joint holders and such joint owners shall be jointly and severally subject to the obligations linked to such VIG Tokens.
...
&nbsp;&nbsp;&nbsp; **4.1** Each Member shall be permitted to vote on the appointment of Custodians to the Custodian Board, and on any other matters prescribed by or pursuant to the Constitution, in proportion to the number of VIG Tokens held by such Member and in accordance with the provisions of the Constitution.

&nbsp;&nbsp;&nbsp; **4.2** Subject to the provisions of any Voting Directive, a quorum for the purposes of any vote of Members prescribed by the Constitution shall be 2% of the outstanding VIG Tokens, from time to time, save and except that a quorum with respect to the vote of Members for the formation of the first Custodian Board, superseding the Genesis Board, shall be 15% of the outstanding VIG Tokens (&quot;Activation Threshold&quot;).

&nbsp;&nbsp;&nbsp; **4.3** Voting by Members on the appointment of Custodians to the Custodian Board, and on any other matters prescribed by the Constitution, shall be in accordance with the procedure, qualifications and mechanism for voting, including but not limited to quorums, consensus, and staking of VIG Tokens as prescribed by Voting Directive from time to time.

&nbsp;&nbsp;&nbsp; **4.5** Any Member shall be entitled to submit Proposals for the consideration and determination of the Custodian Board in accordance with the subject matter, procedure, qualifications and mechanism, including but not limited to staking of VIG Tokens, as prescribed by Proposal Directive from time to time.

&nbsp;&nbsp;&nbsp; **4.6** The usage of any VIG Tokensfor the purposes of submission of Proposals and voting of Members, or any other purpose prescribed by the Constitution, shall be deemed the usage by the holder thereof, whether or not such usage was effected by such holder, any servant or agent thereof or any other person whether authorized or unauthorized.
...
&nbsp;&nbsp;&nbsp; **5.2** The Custodian Board shall be elected by vote of the Members, with the twenty one (21) candidates receiving the highest number of votes being appointed to serve on the Custodian Board (&quot;Appointment Event&quot;).
...
&nbsp;&nbsp;&nbsp; **5.8** Emoluments of each Custodian during a term shall be the median of the Candidate Emoluments Declaration of Custodians appointed for such term divided by twenty one (21), and shall be paid to each Custodian automatically and at the expiration of each term held by such Custodian or as otherwise provided by Nomination Directive.
...
3. The website, available at www.eosUSD.com (&quot;Website&quot;), describing the proposed activities of DAC and the mechanisms through which such activities shall be conducted. By accepting and holding a Token, Member confirms that it has read and understands the Website.
...
**The VIG Tokens (&quot;Token&quot;)**

5. The DAC itelf may distribute some part or all of the initial supply of 1, 000, 000, 000 (One Billion) Tokens to specified persons or entities, inviting such persons or entities, or their transferees or assignees, (&quot;Token Distribution&quot;) to accept and hold such Tokens, _gratis_, and to become a member of the DAC.
...
7. The DAC may hold a token sale once the project has a mainnet implementation.
...
11. Member expressly acknowledges and represents that it has carefully reviewed the T&amp;C and fully understands the risks and benefits associated with the acceptance and holding of the Tokens.
...
33. Any information in the T&amp;C or Website is given for general information purpose only and neither DAC nor any member, employee, officer, director, consultant, advisor, parent, subsidiary affiliate, servant or agent, past, present or future, thereof, shall be construed as providing any representation or warranty as to the accuracy and completeness of such information.

34. The Tokens are not, and are not intended to be, shares or securities of any type and do not entitle the holder thereof to any ownership or other interest in DAC or any person or entity related thereto, and are merely the representation of the holder&#39;s entitlement to membership of the DAC and the means by which the governance of the DAC is effect.
...
41. To the fullest extent permitted by applicable law, neither DAC, nor any member, employee, officer, director, consultant, advisor, parent, subsidiary affiliate, servant or agent, past, present or future, thereof (&quot;Released Parties&quot;), assumes any liability or responsibility for any loss arising or related to the Token Distribution or any transfer or assignment of Tokens, or any technical, interruption or malfunction of thereof.
...
50. This T&amp;C, including any exhibits attached hereto and the materials incorporated herein by reference, constitutes the entire agreement between the parties hereto and supersedes all prior or contemporaneous agreements and understandings, both written and oral, between such parties with respect to the subject matter hereof, including, without limitation, any public or other statements or presentations made by any of DAC, or any member, employee, officer, director, consultant, advisor, parent, subsidiary affiliate, servant or agent, past, present or future, thereof.
